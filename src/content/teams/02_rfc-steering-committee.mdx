...
description: This committee is responsible for forming an RFC Shepherd team from the available nominations on each RFC. This team also names the leader of the Shepherd team.
members:
- name: Kevin Cox
  username: kevincox
