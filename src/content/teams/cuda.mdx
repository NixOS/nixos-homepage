...
- [Manual](https://nixos.org/manual/nixpkgs/unstable/#cuda)
- [Discourse](https://discourse.nixos.org/t/announcing-the-nixos-cuda-maintainers-team-and-a-call-for-maintainers/18074)
- [Matrix](https://app.element.io/#/room/#cuda:nixos.org)
- [GitHub project board](https://github.com/orgs/NixOS/projects/27)
