...
You can install NixOS on physical hardware by burning one of the CD images onto a blank CD/DVD disk, or [by copying it onto a USB stick](https://nixos.org/nixos/manual/index.html#sec-booting-from-usb). For **installation instructions**, please see the [manual](/manual/nixos/stable).
...
<div class="grid grid-flow-row gap-6 my-4 md:mx-[1rem] justify-start">
  <span>
    <Button
      color="semidarkblue"
...
<div class="grid grid-flow-row justify-start gap-6 my-4 md:mx-[1rem] mb-[1rem]">
  <span>
      <Button
      color="semidarkblue"
