...
<div class="my-[1rem]">
  <Button
    color="semidarkblue"
    href="https://channels.nixos.org/nixos-23.05/latest-nixos-x86_64-linux.ova"
    shaHref="https://channels.nixos.org/nixos-23.05/latest-nixos-x86_64-linux.ova.sha256"
    shaText="(SHA-256)"
