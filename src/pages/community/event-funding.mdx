...
<div class="mb-16 flex justify-center">
	<Button href="https://github.com/NixOS/foundation/issues/new?labels=funding-request%2Ctriage&template=funding_form.yml&title=%5BFunding%5D%3A+%24event+name+%24date">Apply</Button>
</div>
...
- Collection of all responses between the submission times
- Reviewing and prioritising the applications
...
- Events that are focused on advocating Nix and attracting new community members
- Events that are focused on building software using the Nix ecosystem
