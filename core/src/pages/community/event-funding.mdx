...
import Button from '@nixos/ui/Button.astro';
...
Events that are funded by this process should be open and advertised in the public. They must be followed by a short public report including a photo or a written report of the event and the outcomes. This will be shared on official social media channels. For instance, you can apply if you're planning to organize:
