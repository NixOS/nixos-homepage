...
console.log(chalk.red('--- The link outputted by the Astro dev server does not include external content like manuals, pills and demos'));
...
app.listen(devServer.address.port + 1, () => {
  console.log(
    ...
    '\n' +
    chalk.gray('--- The following link does include external content like manuals, pills and demos\n') +
